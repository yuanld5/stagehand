...
async function main() {
  ...
  */
  ...
  let prompt_conent = "指令：根据要求大模型输出的数据格式抽取内容\n" + "DOM：\n";

  const json_text = await readFile("/Users/farmer/Documents/Eagles/boomsearch/examples/collect-paginated-news-headlines/httpreq.txt", "utf-8");
